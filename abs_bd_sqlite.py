...
class bg : #background maintainance
 ...
 def POST(self):
   ...
   try:
     #cur_tab.execute("BEGIN EXCLUSIVE")
     cur_tab.execute("insert into filelist(server,name,filename,mediatype,rand,\
     encryptstr,bandwith,date) values('%s','%s','%s','%s','%s','%s','%s','%s')" \
